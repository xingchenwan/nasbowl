    ...
    for arch in best_archs:
        ...
        while n_child < per_arch and patience_ > 0:
            ...
            if benchmark == 'nasbench101':
                ...
                if observed_archs_unpruned is not None:
                    child.arch, child.unpruned_arch = guided_mutate_arch101(arch.arch, feature_names_in_this_arch,
                                                                            feature_grads_in_this_arch,
                ...
                child.arch, child.unpruned_arch = guided_mutate_arch201(arch.arch, feature_names_in_this_arch,
                                                                        feature_grads_in_this_arch,
                                                                        return_unpruned_arch=False,
                                                                        change_grad_sign=True,
                                                                        debug_feature_names=[feature_names,
                                                                                             feature_incidence])
